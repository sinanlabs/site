...
<div style="margin-top:16px;display:flex;gap:10px;flex-wrap:wrap"><a class="btn p" href="%s/login?return_to=%s/">登录 / 注册 →</a><a class="btn o" href="%s/method">先看看我们怎么算的</a></div></section>
...
<p class="lead" style="margin-top:14px">想按站、按模型收提醒：登录后在站点页或模型页点"关注"。</p><a class="btn o" style="margin-top:10px" href="%s/login?return_to=%s/subscribe">登录 / 注册 →</a></section>
